...
def process_event(assistant, event, denon):
    ...
    if event.type == EventType.ON_START_FINISHED:
        ...
        words = text.split()
        if 'receiver' in words or 'denon' in words or 'listen' in words or 'watch' in words or 'xbox' in words or 'games' in words 'apple' in words or 'tv' in words or 'music' in words or 'movie' in words or 'mode' in words:  
